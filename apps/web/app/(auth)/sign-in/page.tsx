...
function GoogleIcon() {
  return (
    ...
    >
      <path
        d="M21.35 12.24c0-.72-.06-1.25-.19-1.8H12v3.48h5.38c-.11.87-.72 2.18-2.08 3.06l-.02.12 3.03 2.35.21.02c1.92-1.77 3.03-4.38 3.03-7.23Z"
        fill="#4285F4"
      />
      <path
        d="M12 21.75c2.64 0 4.85-.87 6.47-2.37l-3.08-2.39c-.82.57-1.93.96-3.39.96-2.59 0-4.79-1.71-5.57-4.08l-.11.01-3.15 2.44-.04.11c1.61 3.18 4.9 5.32 8.87 5.32Z"
        fill="#34A853"
      />
      <path
        d="M6.43 13.87A5.97 5.97 0 0 1 6.1 12c0-.65.12-1.28.32-1.87l-.01-.13-3.19-2.48-.1.05A9.74 9.74 0 0 0 2.25 12c0 1.58.38 3.07 1.06 4.43l3.12-2.56Z"
        fill="#FBBC05"
      />
      <path
        d="M12 6.04c1.84 0 3.08.8 3.79 1.47l2.77-2.7C16.84 3.23 14.64 2.25 12 2.25 8.03 2.25 4.74 4.39 3.13 7.57l3.3 2.56C7.22 7.75 9.41 6.04 12 6.04Z"
        fill="#EA4335"
      />
    </svg>
  )
    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-sans text-[10px] font-medium tracking-[0.2em] text-muted-foreground">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <input
                id="remember"
                type="checkbox"
                className="h-4 w-4 cursor-pointer rounded-sm border-border bg-background disabled:cursor-not-allowed"
                disabled={loading}
              />
              <label
                htmlFor="remember"
