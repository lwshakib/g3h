    ...
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="font-sans text-sm leading-relaxed text-muted-foreground">
          {submitted
            ? "Recovery link sent! Please check your inbox to activate your account."
            : "Enter your email address and we'll send you a verification link to reset your account."}
        </p>
      </div>
      ...
      {!submitted ? (
        ...
        <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/10 p-6 text-center">
          <p className="mb-4 font-sans text-sm text-emerald-600 dark:text-emerald-400">
            Recovery instructions sent to **{email}**. Please follow the link in
