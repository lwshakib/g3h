...
function NodeStatusBorder({ status }: { status: NodeRunStatus }) {
    ...
    >
      ...
      <div className="flex items-center justify-center">
        ...
        >
          ...
          <MousePointerIcon className="size-11 stroke-[1.8] text-[#8a8a8a]" />
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center">
        ...
        >
          <NodeStatusBorder status={runStatus} />
          <WebhookIcon className="size-11 stroke-[1.8] text-[#8a8a8a]" />
          <NodeConfigIndicator configured={configured} runStatus={runStatus} />
          <Handle
            type="source"
            position={Position.Right}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center">
        ...
        >
          <NodeStatusBorder status={runStatus} />
          <CalendarClockIcon className="size-11 stroke-[1.8] text-[#8a8a8a]" />
          <NodeConfigIndicator configured={configured} runStatus={runStatus} />
          <Handle
            type="source"
            position={Position.Right}
    ...
    >
      ...
      <div className="flex items-center justify-center">
        <div className="relative flex h-[94px] w-[94px] items-center justify-center rounded-[24px] border border-[#3a3a3a] bg-[#1f1f1f] shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
          <NodeStatusBorder status={runStatus} />
          <GlobeIcon className="size-11 stroke-[1.8] text-[#8a8a8a]" />
          <NodeConfigIndicator configured={configured} runStatus={runStatus} />
...
function AnthropicExecutionNode({
  id,
  data,
