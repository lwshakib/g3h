...
import { WebhookIcon, PlusIcon } from "lucide-react"
...
export function WebhookTriggerNode({ id, data }: NodeProps) {
  ...
  const configured = isNodeConfigured("webhookTrigger", data as WorkflowNodeData)

  return (
    <div
      className="group/node relative w-[244px]"
      onDoubleClick={() => ctx?.openNodeEditor(id, (data as WorkflowNodeData).label, "Trigger")}
    >
      <NodeTopToolbar
        onDelete={() =>
      ...
      <div className="flex items-center justify-center">
        ...
        >
          ...
          <WebhookIcon className="size-11 stroke-[1.8] text-muted-foreground" />
