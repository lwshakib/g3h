...
import { AnthropicLogoIcon } from "../icons"
import { SelectorContext } from "../contexts"

export function AnthropicExecutionNode({ id, data }: NodeProps) {
  ...
  const configured = isNodeConfigured("anthropicExecution", data as WorkflowNodeData)
