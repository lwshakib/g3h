...
export function HttpRequestNode({ id, data }: NodeProps) {
  ...
  const configured = isNodeConfigured("httpRequest", data as WorkflowNodeData)
    ...
    >
      ...
      <div className="flex items-center justify-center">
        <div className="relative flex h-[94px] w-[94px] items-center justify-center rounded-[24px] border border-border bg-card shadow-sm">
          ...
          <GlobeIcon className="size-11 stroke-[1.8] text-muted-foreground" />
