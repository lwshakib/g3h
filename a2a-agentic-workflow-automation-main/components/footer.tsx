...
const links = [
    {
        ...
        items: [
            ...
            { title: 'Pricing / Plans', href: '/sign-up' },
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Status', href: 'https://status.a2a.dev' },
            { title: 'Changelog', href: 'https://github.com' },
            { title: 'Docs', href: '#features' },
    ...
    },
    {
        ...
        items: [
            ...
            { title: 'Careers', href: 'mailto:hello@a2a.dev' },
            { title: 'Press', href: '#contact' },
            { title: 'Contact', href: '#contact' },
            { title: 'Community', href: 'https://discord.com' },
        ],
    },
    {
        group: 'Legal',
        items: [
            ...
            { title: 'Security', href: '#how-it-works' },
        ],
    },
]
        ...
        <footer className="border-b bg-white pt-20 dark:bg-transparent">
            ...
            <div className="mx-auto max-w-5xl px-6">
                ...
                <div className="mt-12 flex flex-wrap items-end justify-between gap-6 border-t py-6">
                    <small className="text-muted-foreground order-last block text-center text-sm md:order-first">© {new Date().getFullYear()} A2A Workflow, All rights reserved</small>
                    <form action="">
